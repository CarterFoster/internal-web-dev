  ...
  return (
    <div className="max-w-7xl mx-auto">
      <h1 className="text-6xl font-bold text-center w-fit mx-auto mt-20">
        Supercharge Your Productivity with AI-Powerred Focus
      </h1>

      <h2 className="test-xl font-semibold w-fit mx-auto mt-10">
        Join the waitlist and be the first to elevate your workday with
        FocusFlow
      </h2>
      <div className="w-fit mx-auto mt-10">
        <Link
          className="text-xl font-semibold bg-red-500 hover:bg-green-500 px-4 py-2 rounded-md"
          href="/waitlist"
        >
          Join the Waitlist
        </Link>
      ...
      <div className="grid grid-cols-3 rounded-md mt-10 gap-36">
        {cards.map((card, index) => {
          return (
            <div className="p-4 border border-blue-500 rounded-md" key={index}>
              {card.icon}
